package org.company.iendo.ui.dialog;
...
import org.company.iendo.other.PickerLayoutManager;
 ...
 * desc   : 日期选择对话框
 */
public final class DayDialog {

    public static final class Builder
            extends UIDialog.Builder<Builder>
            implements PickerLayoutManager.OnPickerListener {

        private final int mStartYear = 0;
        private final int mEndYear = 100;
